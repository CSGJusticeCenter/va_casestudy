...
## Methodology
\vspace{-0.4cm}
All participants have taken one of these programs right before release. The cohort analyzed were released from prison in `r date1-1` and `r date2-1`. Overall recidivism rates are computed. 