...
### [GDOC Recidivism Analysis](va_cs.html)
...
This Quarto file and analysis can be fully reproduced using the source code found at the CSG Justice Center [VA Case Study GitHub Repository](https://github.com/CSGJusticeCenter/va_casestudy). Additionally, CSV data files can be downloaded here: [VA Case Study Data](https://github.com/CSGJusticeCenter/va_data/tree/main/case_study). 
...
For more information about the program and the tools, services, and opportunities available, visit the [Virtual Academy website](https://advancingdataincorrections.org/va).