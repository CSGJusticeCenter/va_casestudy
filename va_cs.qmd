...
```{r dataviz9, echo=FALSE}
suppressMessages(download_this(rrfinal, button_label = "Download Plot", class = "button_large"))
```
...
Now that we have our data in the right format, what are some more engaging ways we can plot recidivism rates for leadership and our stakeholders overall for these programs?
