...
#plot it! this will plot recidivism rates with overlayed staffing text
rr <- ggplot(tabout |> 
  ...
  labs(caption = capture.output(cat("The following programs were missing data in some years:", unique(toupper(prg.NA)), sep=" ")))+
...
tabout2.wgt5 <- tabout2 |>
  ...
  mutate(recid_rate_all_w = clients_served_all*recid_rate_all)
w.a5 <- round(sum(tabout2.wgt$recid_rate_all_w)/total.a5,2)
